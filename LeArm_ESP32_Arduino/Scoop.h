...
private:
    ...
    enum SequenceState { IDLE, STEP_1, STEP_2, STEP_3, STEP_4, STEP_5, STEP_6, STEP_7, STEP_8, STEP_9, STEP_10, STEP_11, STEP_12, STEP_13, STEP_14, STEP_15, STEP_16, STEP_17, STEP_18, STEP_19, STEP_20, STEP_21, STEP_22, STEP_23, STEP_24, STEP_25, STEP_26, STEP_27, STEP_28, STEP_29, STEP_30, STEP_31, STEP_32, FINISHED };
    ...
    void update() {
        ...
        if (millis() - lastStepTime > stepDelay) {
            ...
            switch (currentState) {
                ...
                case STEP_4: currentState = STEP_5; moveArm(196.00, 128.90, 121.10, 56.20, 177.20, 133.20); break;
                case STEP_5: currentState = STEP_6; moveArm(207.50, 115.60, 159.60, 168.40, 151.90, 179.40); break;
                case STEP_6: currentState = STEP_7; moveArm(207.50, 115.60, 186.00, 168.40, 84.80, 184.90); break;
                ...
                case STEP_17: currentState = STEP_18; moveArm(206.50, 120.00, 97.00, 67.20, 177.20, 86.00); break;
                case STEP_18: currentState = STEP_19; moveArm(120.00, 120.00, 209.10, 160.70, 115.60, 217.90); break;
                case STEP_19: currentState = STEP_20; moveArm(193.50, 120.00, 230.00, 170.60, 90.30, 240.00); break;
